    ...
    <div className="fixed top-0 z-40">
      ...
      >
        <div className="flex items-center">
          ...
          <p className=" font-extrabold text-4xl md:text-6xl  text-white my-1  font-[Montserrat] bg-secondary md:text-left z-30 text-transparent bg-clip-text bg-contain ">
            Snout
          </p>
        </div>
